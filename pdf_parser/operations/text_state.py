...
class Tr(PdfTextStateOp):
    ...
    def do_opcode(renderer, render):
        renderer._ts.T_mode = render

class Ts(PdfTextStateOp):
    opcode  = 'Ts'
    @staticmethod
    def do_opcode(renderer, rise):
        renderer._ts.T_rise = rise